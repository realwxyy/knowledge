...
class ProductSchema(ModelSchema):
    ...
    code = fields.String()
    factor_code = fields.Decimal()
    unit = fields.String()
    desc = fields.String()
    standard_price = fields.Decimal()
    in_stock = fields.String()
    origin = fields.String()
    daily_retail_price = fields.Decimal()
    daily_red_line_price = fields.Decimal()
    promotional_red_line_price = fields.Decimal()
